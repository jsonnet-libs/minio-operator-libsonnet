{
  ...
  spec: {
    ...
    '#credsSecret':: d.obj(help=''),
    credsSecret: {
      '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { credsSecret+: { name: name } } },
    },
    '#env':: d.obj(help=''),
    env: {
    ...
    pools: {
      ...
      '#withReclaimStorage':: d.fn(help='', args=[d.arg(name='reclaimStorage', type=d.T.boolean)]),
      withReclaimStorage(reclaimStorage): { reclaimStorage: reclaimStorage },
